...
6. Write verified rows either to `data/verified_places/<source_key>_<video_id>_places.json` and run `python3 scripts/promote_verified_places.py --input <file>`, or write `data/work/videos/<video_id>/place_verification.json` and run `python3 scripts/reduce_agent_artifacts.py --stage place_verification --apply`.
